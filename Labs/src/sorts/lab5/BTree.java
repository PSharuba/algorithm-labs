...
public class BTree<Key extends Comparable<Key>, Value> {
    ...
    private final static class Node<Key extends Comparable<Key>, Value> {
         ...
         *
         * @param a         упорядоченный массив, в котором ищетсяс элемент
         * @param fromIndex нижняя граница поиска
         * @param toIndex   верхняя граница поиска
         ...
         * 1.
         *
         * @param left           левый из соседей
         * @param right          правый из соседей
         * @param delimeterIndex индекс элемента, раделяющего соседей в узле-родителе.
         ...
         *
         * @param k массив ключей
         * @param v массив значений
         * @param l массив промежуточных ссылок
         * @param c количество элементов
         * @param p ссылка на родительский узел
         */
...
//                sb.append("), ");
         ...
         *
         * @param pos          позиция, куда вставляем
         * @param k            добавляемый ключ
         * @param v            добавляемое значение
         * @param lazyOverfill определяет необходимость проверки переполнения узла
         */
         ...
         * @param k         добавляемый ключ
         * @param v         добавляемое значение
         * @param nodeLeft  левая ссылка
         * @param nodeRight правая ссылка
         ...
         *
         * @param indexLeft индекс ссылки из родителя, указывающей на левого из
         *                  соседей.
         */
         ...
         * @param put обозначает, ищется ли узел для вставки. Иначе - ищется для
         *            получения.
        ...
        private void split() {
            ...
            /*
             * VI. Пихаем вверх центральный элемент, либо создаем новый корень с
             * ним же
             */
            if (parent == null) {
                keys[0] = keys[h];
    ...
    public void postOrderPrint(Node<Key, Value> root) {
        if (root == null) return;
        if (root.links != null)
            for (Node<Key, Value> node : root.links) {
                postOrderPrint(node);
            }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 18; i++) {
            tree.put(i, (int) (Math.random() * 160));
        }
